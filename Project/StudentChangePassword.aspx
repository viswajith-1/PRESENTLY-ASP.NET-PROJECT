<%@ Page Title="" Language="C#" MasterPageFile="~/StudentMasterPage.master" AutoEventWireup="true" CodeFile="StudentChangePassword.aspx.cs" Inherits="StudentChangePassword" %>
                        ...
                        <tr>
                            <td>
                                <asp:Label ID="Label1" runat="server" Font-Names="Cambria" Font-Size="Large" 
                                    ForeColor="#0000CC" Text="Student ID: "></asp:Label>
                                &nbsp;&nbsp;&nbsp;
                                <asp:Label ID="lblStudentID" runat="server" Font-Names="Cambria" 
